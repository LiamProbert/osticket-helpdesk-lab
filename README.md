...
**LDAP Integration**
- Installed the LDAP Authentication and Lookup plugin
- Resolved a missing Net_LDAP2 PEAR dependency
...
This is the second project where Fedora's default SELinux policy has required explicit configuration. Worth noting for anyone running osTicket on Fedora or RHEL-based systems:
